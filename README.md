...
>O participante pode tanto ilustrar uma barreira como uma muralha, uma multidão, um abismo, etc...
    ...
    o cavaleiro se deparou com a ponte da qual comentaram na taverna.
    Ela não era só antiga, como também estava destruída.

>... Quanto pode usar a ideia para limitar o progresso do personagem através de um medo, um imprevisto ou conduta.

    Ao analisar os dados no computador,
    o ciborgue descobriu que sua família havia sido feita de refém.
    Seu plano de invadir a central do crime foi invalidado.
    Agora ele precisava agir de forma cautelosa.
